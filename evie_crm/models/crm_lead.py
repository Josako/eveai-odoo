...
class CrmLead(models.Model):
    ...
    x_evie_language = fields.Many2one(
        ...
        help="Language of the lead, mirrored with Evie both directions via "
             "the Evie language mapping (Configuration → Evie). The dropdown "
             "offers exactly the mapped languages (res_lang.name_search, "
             "context key evie_mapped_only). Empty means unset — the sync "
             "never clears a language.",
    )
